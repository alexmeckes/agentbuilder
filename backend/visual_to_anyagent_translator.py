    ...
    def _add_composio_tools(self):
        ...
        try:
            ...
            composio_tools = {
                ...
                "composio_googledocs_create_doc": self._create_composio_tool_wrapper("create_document"),
    ...
    try:
        ...
        def get_actual_tools(tool_names):
            ...
            try:
                ...
                composio_tools = {
                    "composio_googledocs_create_doc": create_composio_wrapper("create_document"),
